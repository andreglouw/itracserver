...
public class GC101Properties extends Group implements IPropertyComposite {
	 ...
	 * @param style
	 */
	public GC101Properties(Composite parent, int style, UnitPropertyPage control) {
		super(parent, style);
	...
	public void buildFromObject() {
		GC101Unit unit = (GC101Unit)PersistantObject.resolveProxy(control.getElement().getAdapter(Object.class));
	...
	public boolean performOk() {
		GC101Unit unit = (GC101Unit)control.getUnit();
		try {
