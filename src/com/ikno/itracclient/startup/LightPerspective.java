...
public class LightPerspective implements IPerspectiveFactory {
	private static final Logger logger = Logging.getLogger(LightPerspective.class.getName());
	public static final String ID = "com.ikno.itracclient.lightperspective";
	...
	public void createInitialLayout(IPageLayout layout) {
		...
		if (mapping == null || mapping.equals("WorldWind"))
