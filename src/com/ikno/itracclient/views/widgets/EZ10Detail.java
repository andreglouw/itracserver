...
public class EZ10Detail extends Group implements IObjectEditor, FocusListener {
	...
	private EZ10Unit unit = null;
	/**
	 * Create the composite
	 * @param parent
	 * @param style
	 */
	public EZ10Detail(Composite parent, int style) {
		super(parent, style);
