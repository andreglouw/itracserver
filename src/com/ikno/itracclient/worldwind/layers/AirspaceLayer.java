 ...
 */
public class AirspaceLayer extends BasicTiledImageLayer {
    ...
    private static LevelSet makeLevels(URLBuilder urlBuilder)
    {
        ...
        params.setValue(AVKey.DATA_CACHE_NAME, "Earth/AirspaceBoundaries");
        params.setValue(AVKey.SERVICE, "http://www.i-see.co.za/cgi-bin/gettile.php");
        params.setValue(AVKey.DATASET_NAME, "Airspace");
