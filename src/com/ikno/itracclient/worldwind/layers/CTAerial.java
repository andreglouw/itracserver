...
public class CTAerial extends BasicTiledImageLayer {
    ...
    private static LevelSet makeLevels()
    {
        ...
        params.setValue(AVKey.DATA_CACHE_NAME, "Earth/CT Aerial");
        params.setValue(AVKey.SERVICE, "http://www.i-see.co.za/cgi-bin/gettile.php");
        params.setValue(AVKey.DATASET_NAME, "CT_Aerial");
