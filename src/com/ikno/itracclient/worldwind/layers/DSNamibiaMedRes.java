...
public class DSNamibiaMedRes extends BasicTiledImageLayer {

	public DSNamibiaMedRes() {
        super(makeLevels());
...
//        this.setOpacity(0.55d);
    ...
    private static LevelSet makeLevels()
    {
        ...
        params.setValue(AVKey.DATA_CACHE_NAME, "Earth/DS Namibia Med Res");
        params.setValue(AVKey.SERVICE, "http://www.i-see.co.za/cgi-bin/gettile.php");
        params.setValue(AVKey.DATASET_NAME, "DSNamibiaMedRes");
        params.setValue(AVKey.FORMAT_SUFFIX, ".jpg");
        params.setValue(AVKey.NUM_LEVELS, 5);
        params.setValue(AVKey.NUM_EMPTY_LEVELS, 1);
        params.setValue(AVKey.LEVEL_ZERO_TILE_DELTA, new LatLon(Angle.fromDegrees(2.0), Angle.fromDegrees(2.0)));
