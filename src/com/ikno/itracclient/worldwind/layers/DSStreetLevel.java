...
public class DSStreetLevel extends BasicTiledImageLayer {

	public DSStreetLevel() {
        super(makeLevels());
    ...
    private static LevelSet makeLevels()
    {
        ...
        params.setValue(AVKey.DATA_CACHE_NAME, "Earth/DS Street Level");
        params.setValue(AVKey.SERVICE, "http://www.i-see.co.za/cgi-bin/gettile.php");
        params.setValue(AVKey.DATASET_NAME, "DSStreet");
