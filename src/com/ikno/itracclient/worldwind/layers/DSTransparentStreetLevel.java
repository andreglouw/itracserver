...
public class DSTransparentStreetLevel extends BasicTiledImageLayer {

	public DSTransparentStreetLevel() {
        super(makeLevels());
    ...
    private static LevelSet makeLevels()
    {
        ...
        params.setValue(AVKey.DATA_CACHE_NAME, "Earth/DS Transparent Street Level");
        params.setValue(AVKey.SERVICE, "http://www.i-see.co.za/cgi-bin/gettile.php");
        params.setValue(AVKey.DATASET_NAME, "DSStreetTransparent");
    ...
    {
        return "DS Transparent Street Level";
    }
}
