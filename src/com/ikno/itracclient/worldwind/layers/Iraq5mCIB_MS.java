...
import gov.nasa.worldwind.util.LevelSet.SectorResolution;

public class Iraq5mCIB_MS extends BasicTiledImageLayer {
    ...
    private static LevelSet makeLevels(URLBuilder urlBuilder)
    {
        ...
        params.setValue(AVKey.DATA_CACHE_NAME, "Earth/Iraq5m_MS");
        params.setValue(AVKey.SERVICE, "http://www.i-see.co.za/tracking/servlet/mapservice?service=wwtile");
        params.setValue(AVKey.DATASET_NAME, "Iraq_5m_MS");
